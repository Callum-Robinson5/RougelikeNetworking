...
void World::Run(int difficulty)
{
    ...
    while (m_Window.isOpen())
    {
        ...
        for(int i = 0; i < numOfAI; i++)
        {
            ...
            {
                m_Enemies[i].Update(m_Player.m_pos, difficulty);
            ...
            if(m_Enemies[i].projectile.m_Projectile.getGlobalBounds().intersects(m_Player.m_Player.getGlobalBounds()))
            {

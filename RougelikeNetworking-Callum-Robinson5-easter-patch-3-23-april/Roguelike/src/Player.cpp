...
void Player::p_Move()
{
    //Player move on keys and collisions with walls list using sfml global bounds collisions
...
void Player::Update()
{
    ...
    //update for currently fired bullets
...
void Player::shoot(sf::RenderWindow& window)
{
    ...
    //if left mouse is down will fire bullets at the current mouse position and add it to a vector for bullet update
